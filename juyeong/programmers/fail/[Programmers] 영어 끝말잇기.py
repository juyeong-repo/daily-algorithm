...
def solution(n, words):
 ...
 "tank", "kick", "know", "wheel", "land", "dream", "mother", "robot", "tank"
  ...
  사용자 1, 2, 3 이 있을때 이 번호는
  인덱스를 n명으로 나누고, 여기에 1 을 더한 값과 같다.
...
userNum
  0  은 어떤 수로 나누든, 나머지는 0이다. (0을 어떤 양의 정수로 나누든 항상 나머지가 0이 된다.) -> 1
  1 을 3으로 나누면 : 몫 0 , 나머지 1 -> 2
  2 를 3으로 나누면 : 몫 0, 나머지 2 -> 3
  3 을 3으로 나누면 : 몫 0, 나머지 3 -> 4
  4 를 3으로 나누면 : 몫 1, 나머지 1 -> 2
